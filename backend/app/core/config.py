...
class Settings(BaseSettings):
    ...
    MONGODB_DATABASE: str = Field(default="bigfat", description="MongoDB database name")
    MONGODB_COLLECTION: str = Field(default="chatbot", description="MongoDB collection for chatbot conversations")
